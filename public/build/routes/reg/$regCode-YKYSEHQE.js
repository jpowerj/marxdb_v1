import {
  EntryDetailsPanel
} from "/build/_shared/chunk-AWD52SF5.js";
import "/build/_shared/chunk-6EQGYKY7.js";
import {
  require_Info
} from "/build/_shared/chunk-M4D3OZQE.js";
...
import {
  ...
  init_TableContainer,
  require_dist
} from "/build/_shared/chunk-ZMXBJVIV.js";
import {
  init_tiny_invariant
} from "/build/_shared/chunk-3MBIIICT.js";
import "/build/_shared/chunk-G2GGUSV5.js";
import "/build/_shared/chunk-TN3QNU6F.js";
import {
  init_Paper
...
import {
  Typography_default,
  init_Typography
} from "/build/_shared/chunk-CVMSKPMO.js";
import {
...
function RegTable() {
  ...
  const data_cols = [
    ...
    { field: "year_combined", title: "Year", width: "70px", maxWidth: "70px", minWidth: "70px", headerStyle: { textAlign: "center" }, cellStyle: { textAlign: "center" } }
  ];
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TableContainer_default, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_core.default, {
      ...
      data: (query) => new Promise((resolve, reject) => {
        ...
        fetch(`/fetch/reg/${authName}/10/${queryPage}`).then((response) => response.json()).then((rsJson) => {
          resolve({
            data: rsJson.docs,
            page: queryPage,
      ...
      components: {
        ...
        Toolbar: (props) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box_default, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_core.MTableToolbar, {
...
//# sourceMappingURL=/build/routes/reg/$regCode-YKYSEHQE.js.map
