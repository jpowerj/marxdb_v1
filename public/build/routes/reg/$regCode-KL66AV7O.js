import {
  EntryDetailsPanel
} from "/build/_shared/chunk-KOIPFWFD.js";
...
function RegTable() {
  ...
  const data_cols = [
    ...
    { field: "day_combined", title: "Day", cellStyle: { textAlign: "right" }, headerStyle: { textAlign: "center", width: "50px" }, width: "50px" },
    { field: "month_combined", title: "Month", width: "50px" },
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_core.default, {
      ...
      components: {
        Cell: (props) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_core.MTableCell, {
          className: "overflow-hidden text-ellipsis whitespace-nowrap max-w-[500px]",
          ...props
        }, void 0, false, {
          fileName: "app/routes/reg/$regCode.tsx",
          lineNumber: 148,
...
//# sourceMappingURL=/build/routes/reg/$regCode-KL66AV7O.js.map
