import {
  require_OpenInNew
} from "/build/_shared/chunk-6EQGYKY7.js";
import {
  require_Info
...
} from "/build/_shared/chunk-TVJDINII.js";
import {
...
import {
  IconButton_default,
  init_IconButton
} from "/build/_shared/chunk-TN3QNU6F.js";
import {
  init_Paper
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_core.default, {
      ...
      data: (query) => new Promise((resolve, reject) => {
        ...
        if (query.search === "") {
          ...
          fetch(`/fetch/chron/search/${query.search}`).then((response) => response.json()).then((rsJson) => {
            resolve({
              data: rsJson.docs,
              page: query.page,
              totalCount: rsJson.total
...
//# sourceMappingURL=/build/routes/chron/$chronCode-VT22UN7O.js.map
